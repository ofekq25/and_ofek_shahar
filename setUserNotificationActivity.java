...
public class setUserNotificationActivity extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_set_user_notification);
        ...
        buttonCancelAlarm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(setUserNotificationActivity.this, User_nav_Activity.class));
    ...
    private void startAlarm(Calendar c) {
        ...
        startActivity(new Intent(this, User_nav_Activity.class));
