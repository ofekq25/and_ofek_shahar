...
public class EventDetails5 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Ititle.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        if (view == enterEventBtn){
            ...
            startActivity(new Intent(EventDetails5.this,User_nav_Activity.class));
