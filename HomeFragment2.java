...
public class HomeFragment2 extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Add_notify_btn = v.findViewById(R.id.notifications_list);
        b = v.findViewById(R.id.Message);
    ...
    public void onCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater inflater) {
        inflater.inflate(R.menu.menu_managers,menu);
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(item.getItemId()== R.id.menu_logout2){
            mAuth.signOut();
        ...
        if(item.getItemId()== R.id.menu_edit2){
    ...
    public void onClick(View view) {
        if(view == Add_notify_btn){
            startActivity(new Intent(getActivity(),setNotificationActivity.class));
        }
