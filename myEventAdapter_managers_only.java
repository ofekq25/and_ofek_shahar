...
public class myEventAdapter_managers_only extends RecyclerView.Adapter<myEventAdapter_managers_only.ViewHolder> implements Filterable {
    ...
    public myEventAdapter_managers_only(Context context){
