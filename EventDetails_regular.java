...
public class EventDetails_regular extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_innerprofile_manager2);
        ...
        enterEventBtn.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        if(view == backPreviousPage){
            ...
            //startActivity(new Intent(EventDetails2.this, User_nav_Activity.class));
        }
        if (view == enterEventBtn){

            addUser(eventData,userName_keep);
            addToManager(eventData,userName_keep);
            startActivity(new Intent(EventDetails_regular.this,User_nav_Activity.class));
