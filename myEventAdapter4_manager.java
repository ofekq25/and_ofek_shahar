...
public class myEventAdapter4_manager extends RecyclerView.Adapter<myEventAdapter4_manager.ViewHolder> implements Filterable {
    ...
    public myEventAdapter4_manager(Context context){
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        //private ImageView mImageView; todo
                                ...
                                public void onClick(View view) {
                                    if (listener != null){
                                        ...
                                        if(position != RecyclerView.NO_POSITION){
                                            ...
                                            Intent i = new Intent(context, EventDetails7.class);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.event_item_design4, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //Toast.makeText(context, "hello4554", Toast.LENGTH_SHORT).show();
                if(userName.getIsManager()==false){
    ...
    public void deleteDialog2(Event event){ //todo open dialog to delete  user
