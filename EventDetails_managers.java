...
public class EventDetails_managers extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_innerprofile_manager);
    ...
    public void onClick(View view) {
        if(view ==Ititle){
            Toast.makeText(this, "gfdg", Toast.LENGTH_SHORT).show();
        }
